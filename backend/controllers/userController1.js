...
const generateToken = (id) => {
    return jwt.sign({ id }, process.env.JWT_SECRTET, {expiresIn: '1d'});
}
...
const loginStatus = asyncHandler (async (req, res) => {
  ...
  //Verify token
const verified = jwt.verify(token, process.env.JWT_SECRTET);
if(verified){
...
<p>Please reset link is valid for only 3o minutes</p>
...
const subject = 'Password Reset Requset'
